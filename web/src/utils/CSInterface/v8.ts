...
class Extension {
    ...
    constructor(
        ...
        public defaultExtensionDataXml: ExtensionDispatchInfo,
        public specialExtensionDataXml: ExtensionDispatchInfo,
...
class CSEvent {
    ...
    constructor(
        public type: string,
        public scope: CSInterface.EventScope,
        public appId: string,
...
class RGBColor {
     ...
     */
    constructor(
        public red: RGBNumber,
        public green: RGBNumber,
        public blue: RGBNumber,
        public alpha: RGBNumber = 255,
    ) {}
}
...
export class CSInterface {
     ...
     */
    public hostEnvironment: HostEnvironment = window.__adobe_cep__
     ...
     */
    addEventListener<T extends CSEvent>(
        type: string,
        listener: (evt: T) => void,
        obj?: object,
    ): void {
...
export namespace CSInterface {
     ...
     *
     */
    export const THEME_COLOR_CHANGED_EVENT = 'com.adobe.csxs.events.ThemeColorChanged';
}
...
export type { ExtensionDispatchInfo, ApiVersion, HostCapabilities, HostEnvironment, AppSkinInfo };

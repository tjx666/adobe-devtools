mod.emitter = (function () {
    'use strict';

    var EventEmitter = mod.EventEmitter;
    var isDev = mod.constants.isDev;
    var getErrorDetails = mod.exception.getErrorDetails;

    var toString = Object.prototype.toString;
    var emitter = new EventEmitter();
    var callbackId = 0;
    var eventNamePrefix = 'devtools.';
            ...
            if (callbackId !== undefined) {
                ...
                try {
                    ...
                    emit(responseEvent, {
                        code: -999,
                        data: null,
                        message: 'JSX Exception in emitter.on callback.\n' + errorDetails,
    ...
    function log() {
        ...
        if (isDev) $.writeln(logStr);
        sendEvent('devtools.console.log', logStr);
    }

    function error(data) {
        sendEvent('devtools.console.error', data);
    }

    function alert(data) {
        sendEvent('devtools.alert', data);
    }

    function message(content) {
        sendEvent('devtools.message', content);
    }
